...
// AnonymousTag represents a tag with no tag value or payload bytes.
type AnonymousTag interface {
	Tag
	// Anonymous tags have no tag value or payload bytes.
}

// tagAnon is the anonymous tag implementation (no payload bytes).
type tagAnon struct{}

// NewAnonymousTag constructs a Tag representing an anonymous tag.
func NewAnonymousTag() AnonymousTag { return tagAnon{} }
